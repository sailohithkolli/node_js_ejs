...
mongoose.connect('mongodb://10.92.128.39:27017/blogger', { useNewUrlParser: true });
...
app.post('/blogs/add', [check('title').not().isEmpty().withMessage('Title is a required field.'), 
check('author').not().isEmpty().withMessage('Author is a required field.'), 
check('body').not().isEmpty().withMessage('Body field is required.'),   
check('slug').not().isEmpty().withMessage('slug field is required.'),
...
check('author').not().isEmpty().withMessage('Author is a required field.'),
check('body').not().isEmpty().withMessage('Body field is required.'),
check('slug').not().isEmpty().withMessage('Slug field cannot be empty.')],
